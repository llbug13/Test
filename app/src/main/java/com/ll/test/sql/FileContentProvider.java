...
public class FileContentProvider extends ContentProvider {
    ...
    //Populate the UriMatcher object, where a URI ending in 詉tems' will
    //correspond to a request for all items, and 詉tems/[rowID]?  //represents a single row.
    static {
...
//  }
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatcher.match(uri)) {
            case ALLROWS:
                return "vnd.android.cursor.dir/vnd.paad.hoarded";
            case SINGLE_ROW:
                return "vnd.android.cursor.item/vnd.paad.hoarded";
            default:
